...
public class UsersPost {
    ...
    public UsersPost(String name, String email, String currentgrp, String uid, String push, int units, String blood, String urgency, String country, String state, String city, String hospital, String relation, String contact, String info,int volunteer) {
        this.name = name;
        this.email = email;
